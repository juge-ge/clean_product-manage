...
### 1.2 生产工艺
- 主要产品：钢铁制造
- 年产钢量：${props.enterpriseData.annualOutput || '待填写'}万吨
- 生产能力：${props.enterpriseData.productionCapacity || '待填写'}万吨/年
...
### 2.3 审核结果
- 总体评分：${props.auditData.totalScore || 0}分
- 审核等级：${props.auditData.overallLevel || '待评估'}
- 待改进项数：${props.auditData.improvementItems || 0}项
- 限定性指标：${props.auditData.limitingIndicators || 0}项
